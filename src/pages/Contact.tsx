          ...
          <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">info@jurchentech.com</p>
                    <p className="text-gray-600">support@jurchentech.com</p>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://youtube.com" className="bg-red-600 text-white p-3 rounded-full hover:bg-red-700" aria-label="YouTube">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
